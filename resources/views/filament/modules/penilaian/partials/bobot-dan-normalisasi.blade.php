{{-- Keterangan total bobot; tombol Normalisasi Bobot di samping lewat Flex/Actions. --}}
@if ($ringkasan !== null)
    @php
    ...
    <div
        class="{{ $palet['tone'] }}"
        style="padding:10px 14px;border-radius:10px;border:1px solid {{ $palet['border'] }};font-size:13px;"
    >
