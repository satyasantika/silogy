 ...
 * tertinggi pada unit kepemimpinan Pimpinan (beserta seluruh keturunannya),
 * lintas kurikulum & semester.
 */
class PimpinanCapaianTertinggiTable extends TableWidget
{
    use CanAccessDashboardWidgets;

    /** Banyaknya mata kuliah teratas yang ditampilkan. */
    ...
    {
        return $table
            // Baris berasal dari agregasi runtime (bukan record MkUnit utuh),
            // jadi query hanya penampung kosong seperti pola widget serupa.
    ...
    public function barisMkTertinggi(): array
    {
        ...
        return app(DashboardPimpinanService::class)->mkTertinggi($user, self::JUMLAH_MK);
    }
}
