 ...
 * tertinggi, discope ke kelas yang diampu user — analog
 * MkCapaianTertinggiTable milik Tim Kurikulum.
 */
class DosenPengampuCapaianTertinggiTable extends TableWidget
{
    ...
    public function barisMkTertinggi(): array
    {
        ...
        return app(DashboardDosenPengampuService::class)->mkTertinggi($user, self::JUMLAH_MK);
    }
}
