...
class BokResource extends Resource
{
    ...
    {
        return NavigationSortPeran::resolve('bok', 4);
    }
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        $adaptasi = $unitIds->flatMap(fn (string $unitId) => CplBokAdaptasiScope::adaptedBokIdsAcrossUnit($unitId));
        ...
        // academic_unit_id IN (...) meloloskan BoK dari kurikulum manapun
        // pada unit yang sama.
        return $query->where(
