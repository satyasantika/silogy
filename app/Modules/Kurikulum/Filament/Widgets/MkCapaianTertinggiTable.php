 ...
 * tertinggi pada unit kerja tim kurikulum, lintas kurikulum & semester.
 */
class MkCapaianTertinggiTable extends TableWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            // jadi query hanya penampung kosong seperti CplPerMkUnitTable.
    ...
    public function barisMkTertinggi(): array
    {
        ...
        return app(DashboardTimKurikulumService::class)->mkTertinggi($user, self::JUMLAH_MK);
    }
}
