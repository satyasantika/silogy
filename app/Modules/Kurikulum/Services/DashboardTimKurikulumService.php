...
/**
 * Data dashboard Tim Kurikulum: KPI kurikulum yang dikelola serta capaian
 * tertinggi LINTAS KURIKULUM pada unit kerjanya.
 *
 * Berbeda dari DashboardCplDataService (selalu satu unit + satu semester
 * lewat filter dashboard), service ini sengaja tanpa filter: agregasi
 * all-time dari hasil_cpl_mk untuk seluruh unit tempat user menjadi tim
 * kurikulum, supaya capaian dari kurikulum lama tetap terbaca.
 */
class DashboardTimKurikulumService
{
    /** Jumlah kurikulum pada unit kerja user — sama dengan isi daftar /kurikulums. */
     ...
     *
     * @return list<array{mk_nama: string, mk_unit_kode: string, kurikulum_nama: string, rata_rata: float, jumlah_mahasiswa: int}>
     */
